...
<script type="text/javascript">
	function addCategory() {
		...
		function delProduct(id){
			if(confirm("您是否确定删除该分类？")){
				window.location.href = "${pageContext.request.contextPath}/category/AdminCategoryDeleteAction?cid="+id;
			}
		}
</script>
</HEAD>
						...
						<c:forEach items="${categoryList }" var="category">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/category/AdminCategoryEditAction?cid=${category.cid}">
										<img
