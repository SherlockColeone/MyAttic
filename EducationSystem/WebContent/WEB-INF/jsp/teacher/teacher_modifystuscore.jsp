				...
				<div class="col-md-12">
					<div class="col-md-3">
						<a href="#" class="btn btn-default">
							<span class="glyphicon glyphicon-arrow-left"></span>留在本页面
						</a>
					</div>
					<div class="col-md-3 col-md-offset-6">
						<a href="${pageContext.servletContext.contextPath}/teacherCheckStuscore" class="btn btn-default">
							查看学生成绩页面<span class="glyphicon glyphicon-arrow-right"></span>
						</a>
					</div>
				</div>
