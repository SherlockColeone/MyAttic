...
<HTML>
	...
	<body>
		<!-- 跳转到AdminProductSaveAction -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/AdminProductSaveAction" method="post" enctype="multipart/form-data">
			&nbsp;
