			...
			<div id="background" class="col-md-12">
				<div id="context" class="col-md-12">
					<div id="login" class="col-md-offset-7">
						...
						<div id="loginForm" class="col-md-offset-1">
							<form action="${pageContext.servletContext.contextPath}/studentLogin" method="post" id="form" class="bs-example bs-example-form">
						...
						<div id="warning" class="col-md-offset-2">
							${warning }
						</div>
					</div>
				</div>
