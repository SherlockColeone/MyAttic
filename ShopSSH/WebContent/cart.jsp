...
<script type="text/javascript">
	function deleteCartItem(pid) {
		...
		if (confirm("您确定要删除该商品吗?")) {
			location.href = "${pageContext.request.contextPath}/CartAction?method=delete&pid="+ pid;
		} else {
            return false;
		}
	...
	function submitOrder() {
		location.href = "${pageContext.request.contextPath}/CartAction?method=addOrder";	
	}
</script>
</head>
...
<body>
	...
	<c:if test="${empty cart.cartItems  }">
		...
		<a href="${pageContext.request.contextPath }/IndexAction">返回首页</a>
	</c:if>
	<c:if test="${!empty cart.cartItems  }">
		...
		<div class="container">
			...
			<div style="margin-right: 130px;">
				...
				<div
					...
					<a href="${pageContext.request.contextPath }/CartAction?method=clearCart" id="clear" class="clear">清空购物车</a> 
