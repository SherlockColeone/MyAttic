...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/AdminProductUpdateAction?pid=${product.pid}" method="post" enctype="multipart/form-data">
